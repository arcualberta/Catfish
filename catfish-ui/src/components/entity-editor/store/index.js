    ...
    actions: {
        ...
        createNewEntity(type) {
            this.entity = {
                ...
                templateId: Guid.createEmpty().toString(),
        ...
        saveEntity() {
            ...
            this.entity.title = getConcatenatedTitle(this.entity, this.entityTemplate, ' | ');
            this.entity.description = getConcatenatedDescription(this.entity, this.entityTemplate, ' | ');
            ...
            if (newEntity) {
                ...
                if (this.entity?.id?.toString() === Guid.EMPTY) {
                    this.entity.id = Guid.create().toString();
                }
                method = "POST";
            }
            else {
            ...
            let attachedFiles = formSubmissionstore.files;
            let fileKeys = formSubmissionstore.fileKeys;
        ...
        async loadEntity(entityId) {
            this.entity = await entityProxy.Get(entityId);
        ...
        loadEntities(entityType, searchTarget, searchText, offset, max) {
