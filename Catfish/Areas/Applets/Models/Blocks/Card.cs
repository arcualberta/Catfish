...
namespace Catfish.Areas.Applets.Models.Blocks
{
    ...
    [BlockType(Name = "Card", Category = "Content", Component = "card", Icon = "far fa-square")]
    public class Card : Block, ICatfishBlock
    {
        public void RegisterBlock() => App.Blocks.Register<Card>();
