...
using CatfishWebExtensions.Models.ViewModels;
...
namespace CatfishWebExtensions.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            //check if page access is limit to certain domain only and check if iser try to login is belong to the allowed-domain
