...
`), l()), c || o("return "), t.codegenNode ? genNode(t.codegenNode, n) : o("null"), p && (a(), o("}")), a(), o("}"), { ast: t, code: n.code, preamble: "", map: n.map ? n.map.toJSON() : void 0 }
} function genFunctionPreamble(t, e) {
    const { push: n, newline: r, runtimeGlobalName: o } = e; var s; 0 < t.helpers.length && (n(`const _Vue = ${o}
