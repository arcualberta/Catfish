    ...
    public class BusinessContinuityPlanFormBuilderTests
    {
        ...
        public void BCP_MainEssentialFunctionandBATest()
        {
           ...
           // Define_EmailTemplate();
            ...
            //Defininig the inspection form
            DataItem bcpForm = template.GetDataItem("BCP Essential Function and Business Impact Analysis Worksheet Form", true, lang);
            bcpForm.IsRoot = true;
            ...
            bcpForm.CreateField<RadioField>("Priority Rating + RTO", lang, GetRTOList(), true).SetFieldLabelCssClass("col-md-12")
        ...
        {
            return new string[] { "Critical -- Directly impacts life, health, safety, or security. Cannot stop. (RTO: < 4 hours)", 
             "High -- Must continue at normal or increased level. Pausing for more than 24 hours may cause significant consequences or serious harm. (RTO: < 24 hours)", 
            "Medium -- Must continue if at all possible, perhaps in reduced mode. Stopping for more than one week may cause major disruption. (RTO: < 1 week)",

             "Low -- May be suspended for up to one month without causing significant disruption. (RTO: < 1 month)",
            "Deferable -- May pause and resume when conditions permit. (RTO: > 1 month)" };
        }
