...
All required supporting documentation must be <span style='color: Red;'><b>combined into a single PDF</b></span> and submitted here. Maximum file size: 50 MB", lang);
            ...
            EmailTrigger supervisorNotificationEmailTrigger = workflow.AddTrigger("ToSupervisor", "SendEmail");
            supervisorNotificationEmailTrigger.AddRecipientByDataField(confForm.Id, supervisorEmail.Id);
            supervisorNotificationEmailTrigger.AddTemplate(advisorEmailTemplate.Id, "Supervisor Email Notification");
