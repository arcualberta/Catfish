...
// using System.Data.Entity;  KR:.NETCORE 
using Microsoft.EntityFrameworkCore; // KR:.NETCORE 
using System.Linq;
using System.Text;
...
namespace Catfish.Core.Services
{
    public class EntityService : ServiceBase
    {
        ...
        {
            //KR:.NETCORE CFEntityType result = Db.EntityTypes.Add(entityType);
            CFEntityType result = Db.EntityTypes.Add(entityType).Entity;
        ...
        {
            //KR:.NETCOREDb.Entry(entity).State = EntityState.Modified;
