...
namespace Catfish.Core.Contexts
{
    public class AccessContext
    {
        ...
        // public AccessContext(Guid userGuid, bool isAdmin, CatfishDbContext db = null) KR:.NETCORE
        public AccessContext(Guid userGuid, bool isAdmin, CatfishDbContext db)
        {
            UserGuid = userGuid;
            IsAdmin = isAdmin;
            mDb = db;
