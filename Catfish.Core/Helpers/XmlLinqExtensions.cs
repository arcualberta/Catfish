    ...
    public static class XmlLinqExtensions
    {
        ...
        ) where TSource : CFXmlModel
        {
            ...
            if (SolrService.IsInitialized)
            {
                ...
                //return set.SqlQuery(query).AsQueryable(); KR:.NETCORE
                return set.FromSqlRaw<TSource>(query).AsQueryable();
        ...
        AccessMode mode = AccessMode.Read) where TSource : CFXmlModel
        {
            ...
            // return set.SqlQuery(sqlQuery).AsQueryable().Distinct(); KR:.NETCORE
            return set.FromSqlRaw<TSource>(sqlQuery).AsQueryable();
        }
