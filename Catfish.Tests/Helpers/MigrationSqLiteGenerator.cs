...
// Code obtained from: https://stackoverflow.com/questions/15887145/entity-framework-migrationsqlgenerator-for-sqlite
    ...
    public class MigrationSqLiteGenerator : MigrationSqlGenerator
    {
        ...
        protected virtual void Generate(CreateIndexOperation opeCriacaoIndex)
        {
            using (var ltextWriter = TextWriter())
            {
                ...
                ltextWriter.Write(string.Format("{0}_{1}", opeCriacaoIndex.Table, opeCriacaoIndex.Name));
